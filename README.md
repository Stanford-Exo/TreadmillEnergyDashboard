...
The goal of the visualizations is to help us make decisions about how to improve gait when walking on the treadmill, how to tweak exoskeleton controllers, and how to design better exoskeletons. We want to know where we can tweak gait to get the energy cost down.
